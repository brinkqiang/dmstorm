#ifndef __PERSON_DM_H_INCLUDE__
#define __PERSON_DM_H_INCLUDE__
...
public:
    ...
    int CreateDB()
    {
        return m_oDB.execute("CREATE DATABASE IF NOT EXISTS db DEFAULT CHARSET = utf8;");
    }
